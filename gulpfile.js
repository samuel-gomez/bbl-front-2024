...
const setClass = require("./pug/js/setClass");
...
const baseData = "./pug/data/";
const getFileData = (fileName) =>
  JSON.parse(fs.readFileSync(`${baseData}${fileName}.json`, "utf8"));
...
gulp.task("serve", () => {
  ...
  gulp.watch(
    ["css/*.scss", "css/print/*.{sass,scss,css}", "pug/**/*.scss"],
